//
//  WifiButtonGridViewController.swift
//  RGB Remote
//
...
class WifiButtonGridViewController: UIViewController {
    ...
    required init?(coder aDecoder: NSCoder) {
        self.dataSource = WifiDataSource(remoteControl: RGBWWRemoteControl())
        self.collectionView = UICollectionView(frame: .zero, collectionViewLayout: UICollectionViewFlowLayout())
...
extension WifiButtonGridViewController {
