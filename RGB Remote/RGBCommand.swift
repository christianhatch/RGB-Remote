...
enum RGBCommand: CommandConvertible {
    ...
    static let basicColors: [RGBCommand] = [.red, .blue, .green, .white, .candle]
    static let effects: [RGBCommand] = [.jump3, .jump7, .fade3, .fade7, .flash, .auto, .quick, .slow]
    
    
    //rgb
    static let rgbControls: [RGBCommand] = [.diy1, .diy2, .diy3, .diy4, .diy5, .diy6,
                                         .redUp, .greenUp, .blueUp, .redDown, .greenDown, .blueDown]
    static let rgbColors: [RGBCommand] = [.candle, .yellowOrange, .yellowGreen, .greenYellow,
                                       .tealBlue, .skyBlue, .indigoBlue, .lightBlue,
                                       .indigo, .violet, .purple, .deepPurple,
                                       .pinkWhite, .purpleWhite, .tealWhite, .indigoWhite]
    
    //rgbww
    static let wwControls: [RGBCommand] = [.whiteOn, .whiteOff, .whiteUp, .whiteDown]
    static let wwControlsFull: [RGBCommand] = wwControls + [.white25, .white50, .white75, .white100]
    static let rgbwwColors: [RGBCommand] = [.candle, .orange, .orangeYellow, .yellow,
    ...
    static let rgbww: [RGBCommand] = [.on, .off, .brightnessUp, .brightnessDown, .red, .blue, .green, .white,
